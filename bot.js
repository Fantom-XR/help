...
bot.errMsg = message => {
  message.channel.send(
    ":x: Error 404: Please enter command properly. There was a **Syntax Error in the command**."
  );
};
bot.permMsg = message => {
...
bot.on("ready", () => {
  ...
  bot.user.setActivity("Disneyland Orlando | ;help ", { type: "Watching" });
  bot.user.setStatus("avalible", null);
});
